...
<html lang="en-us" class="no-js">
	...
	<head>
		...
		<meta charset="utf-8">
        <title>Equipmanager Coming Soon</title>
        ...
        <!-- ============== Resources style ============== -->
        <link rel="stylesheet" href="<?= base_url('assets/comingsoon/') ?>css/style-minimal-light.css" />

		<!-- Modernizr runs quickly on page load to detect features -->
		<script src="<?= base_url('assets/comingsoon/') ?>js/modernizr.custom.js"></script>
	</head>
	...
	<body>
		...
		<script src="<?= base_url('assets/comingsoon/') ?>js/jquery.min.js"></script>
		<script src="<?= base_url('assets/comingsoon/') ?>js/jquery.easings.min.js"></script>
		<script src="<?= base_url('assets/comingsoon/') ?>js/bootstrap.min.js"></script>
		<script src="https://unpkg.com/ionicons@4.2.2/dist/ionicons.js"></script>

		<!-- Newsletter plugin -->
		<script src="<?= base_url('assets/comingsoon/') ?>js/notifyMe.js"></script>

		<!-- Countdown plugin -->
		<script src="<?= base_url('assets/comingsoon/') ?>js/jquery.countdown.js"></script>

		<!-- Main JS File -->
		<script src="<?= base_url('assets/comingsoon/') ?>js/main-minimal.js"></script>
